...
const ContactForm = () => {
  ...
  return (
    <div className="resContainer flex justify-center">
      {" "}
      <div className="border-2 p-4 sm:p-10 md:p-14 w-full lg:w-[900px] rounded-xl shadow-lg bg-white box-border">
          ...
          <div className="formWrapper w-full md:w-[40%]">
            ...
            <div className="flex flex-col">
              {contactArr.map((data, idx) => (
                <div
                  key={idx}
                  className="group cursor-pointer flex items-center gap-x-2 p-4 hover:shadow-lg"
                >
            ...
            <form action="" className="py-2" onSubmit={handleSubmit}>
              ...
              <div className="lg:flex w-full">
                <input
                  ...
                  value={values.budget}
                  onChange={handleChange}
                  className="w-full lg:w-[30%] p-2 outline-none border-b-[2px] border-slate-400 hover:border-primary hover:placeholder:text-primary bg-transparent my-2"
                />
                <input
                  type="text"
                  name="subject"
                  ...
                  onChange={handleChange}
                  className="w-full lg:w-[60%] lg:ml-7 p-2 outline-none border-b-[2px] border-slate-400 hover:border-primary hover:placeholder:text-primary bg-transparent my-2"
                />
              </div>
              <input
                id="message"
    ...
    <div className=" ">
      <div className="flex gap-5 p-2 text-primary">
        {links.map((link, idx) => (
          <div
            key={idx}
            className="text-xl cursor-pointer hover:bg-primary hover:text-white p-2 rounded-sm  cursor-pointer"
          >
            {link.link}
          </div>
        ))}
